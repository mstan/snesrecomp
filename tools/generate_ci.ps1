<#
.SYNOPSIS
Write the release workflow into an existing SNES project (Windows).
...
.EXAMPLE
powershell -File snesrecomp\tools\generate_ci.ps1                 # cwd is the project
.EXAMPLE
powershell -File snesrecomp\tools\generate_ci.ps1 C:\src\MyGame --check
.EXAMPLE
powershell -File snesrecomp\tools\generate_ci.ps1 --force --zip-prefix mygame
#>
